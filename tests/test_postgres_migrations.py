...
def test_postgres_migration_invariants():
    ...
    with _temporary_postgres_database(original_url) as temp_url:
        ...
        for table in CORE_TABLES:
            ...
            assert f"fk_{table}_org_id_organizations" in fk_names
        ...
        stripe_fk_names = {fk.get("name") for fk in inspector.get_foreign_keys("stripe_events")}
        assert "fk_stripe_events_org_id_organizations" in stripe_fk_names
