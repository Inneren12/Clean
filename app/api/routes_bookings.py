    ...
    if deposit_decision.required and deposit_decision.deposit_cents:
        ...
        try:
            ...
            await booking_service.attach_checkout_session(
                session, booking.booking_id, checkout_session.id, payment_intent_id=payment_intent
            )
            ...
            raise HTTPException(status_code=status.HTTP_502_BAD_GATEWAY, detail="Failed to create deposit session") from exc
